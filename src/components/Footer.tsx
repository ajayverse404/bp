      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="https://x.com/binaryprototype" className="group" aria-label="Binary Prototypes on X" target="_blank" rel="noopener noreferrer">
              <svg
            ...
            <Link href="https://instagram.com/binaryprototypes" className="group" aria-label="Binary Prototypes on Instagram" target="_blank" rel="noopener noreferrer">
              <svg
                className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700"
                aria-hidden="true"
                viewBox="0 0 24 24"
